...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Jul 2026 um 17:24
...
('Test', '$2b$12$yuiuAHAj7rVmvuwdvtzg8OAl5pcioe4PGYRWYy6s4wC7SzxmvD3j2', 'dajdj@gmail.com', 'Jovana leck Eier!');
...
--
ALTER TABLE `chat_member`
  ADD CONSTRAINT `chat_room` FOREIGN KEY (`chat_id`) REFERENCES `chat_room` (`chat_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `chat_messages`
  ADD CONSTRAINT `chatRoom` FOREIGN KEY (`chat_id`) REFERENCES `chat_room` (`chat_id`),
  ADD CONSTRAINT `user_name` FOREIGN KEY (`username`) REFERENCES `user` (`username`);

--
-- Constraints der Tabelle `chat_room`
--
ALTER TABLE `chat_room`
  ADD CONSTRAINT `prompt_id` FOREIGN KEY (`prompt_id`) REFERENCES `prompts` (`prompt_id`);
